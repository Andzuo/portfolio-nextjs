    ...
    >
      ...
      <div className="max-w-6xl mx-auto text-center space-y-8">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto"></p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <Button className="bg-purple-600 mt-10 cursor-pointer hover:bg-purple-700 text-lg h-12 px-8">
            Iniciar Projeto
